...
namespace Uitlening
{
    internal class Program
    {
        ...
        private static void PrintUitleningen(Uitlening[] uitleningen, int aantal)
        {
        ...
        private static int Toevoegen(Uitlening[] uitleningen, int aantal, string omschrijving, DateTime ontleendatum)
        {
