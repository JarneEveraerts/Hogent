...
namespace Infrastructure
{
	...
	{
		public static List<Onderhoud> GeefOnderhoudVanAutos()
		{
			List<Onderhoud> onderhoudLijst = new();
			
			DateTime begindatum = new(2019, 12, 12);
			DateTime einddatum = new(2019, 12, 15);
